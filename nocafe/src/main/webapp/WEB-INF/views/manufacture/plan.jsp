...
<div class="container-fluid px-4">
  ...
  <ol class="breadcrumb mb-4">
    <li class="breadcrumb-item">
      <a href="home.do"><i class="fas fa-home"></i></a>
    </li>
    ...
    <div class="card col-xl-11">
      <div class="card-body">
        <div class="d-flex flex-row justify-content-between">
          <div id="grid2" style="width: 64%">제품</div>
          <div id="grid3" style="width: 32%">제품공정확인</div>
        </div>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="card col-xl-11">
      <div class="card-body">
        <div class="d-flex flex-row justify-content-between">
          <div id="grid4" style="width: 64%">사용가능자재</div>
          <div id="grid5" style="width: 32%">자재확인</div>
        </div>
      </div>
    </div>
  </div>
