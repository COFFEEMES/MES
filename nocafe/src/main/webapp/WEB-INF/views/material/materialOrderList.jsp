				...
				<div class="card mb-4">
					<div class="card-body">
						<div class="card-body">
							...
							<tr>
								<th>업체명</th>
								<td><input class="form-control" type="text" id="vendNm" name="vendNm"
						...
						<div class="modal-dialog modal-xl" role="document">
							<div class="modal-content">
								...
								<div class="modal-body">
									<label style="margin-top: 5px">발주코드</label> <input class="form-control" type="text"
										id="ordrCd" name="ordrCd" style="width: 180px; margin-bottom: 10px" readonly />
									<div class="linelist" style="float: right;">

										<button type="button" class="btn btn-primary" id="saveBtn">
											<i class="fas fa-save"></i> 수정
										</button>
										<button id="excelBtn" name="excelBtn" type="button" class="btn btn-primary">
