    ...
    <div class="card col-xl-11">
      <div class="card-body">
        <div class="linelist" style="float: right; margin-bottom: 13px">
          <button type="button" class="btn btn-primary" id="optionSearchBtn">
...
<script>
  ...
  gridPro.on("dblclick", (ev) => {
    ...
    document.getElementById("proName").value =
      gridPro.getData()[ev.rowKey].proNm;
  });
  ...
  //조회버튼 누르면 조회
  document.getElementById("optionSearchBtn").addEventListener("click", search);
