...
<div class="container-fluid px-4">
  ...
  <div class="row">
    <div class="card col-xl-11">
      <div class="card-body">
        <div class="linelist" style="margin-bottom: 16px">
...
<script>
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        data.forEach((row) => {
          ...
          if (detailCnt == 0) grid.addRowClassName(row.rowKey, "not-allow-row");
  ...
  //상세조회 저장버튼
  document.getElementById("okBtn").addEventListener("click", saveOrder);
